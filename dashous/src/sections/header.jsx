...
const Header = () => {
    ...
    return (
        <header className="w-full bg-white h-20 flex justify-center px-6 md:px-0">
            <div className="w-full max-w-[1024px] h-full flex justify-between items-center">
                ...
                {/* Mobile Menu Button */}
                <button
                    className="md:hidden text-gray-200 hover:text-red-default"
            ...
            {/* Mobile Menu Overlay */}
            {isMenuOpen && (
                <div className="md:hidden absolute top-20 left-0 right-0 bg-white shadow-lg z-50 border-t border-gray-200">
